...
\section{System Architecture}
	\subsection{Architectural Design}
		Shown Below is the architectural design for the \textit{AgBizClimate} project. This UML diagram shows the high level components of the application. This Diagram also shows how these components are connected.
	...
	\subsection{Decomposition Description}
		...
		\subsubsection{Front End Controller}
			The Front end Controller will be responsible for 
		\subsubsection{UI}
