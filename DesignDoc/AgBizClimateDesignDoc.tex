	...
	\subsection{Data Dictionary}
		...
		\subsubsection{User Data}
			...
			\subsubsection{Budget}
				...
				\paragraph{time_unit} - Stores how the user would like to measure time for that budget. Some budgets may be measured in years but some may be measured in months or weeks.\\
				
				\paragraph{farm_unit} - This item stores how we plan to measure how much land we have to work with. Most farms will choose to use acres. However for some crops its more useful to use a different type of measurement.\\
				
				\paragraph{farm_unit_quantity} - This describes how large our farm is based on the farm_unit.\\
				
				\paragraph{expense_unit} - This item stores the unit of measurement for an expense. This is similar to a farm_unit.\\
				
				\paragraph{expense_unit_quantity} - This item stores how many of the expense_units we have in our budget.\\
				
				\paragraph{total_cost} - Total cost represents the total cost of the crop we are using this budget for.\\
				
				\paragraph{total_variable_costs} - This represents the total variable cost for this budget. Variable costs are cost that can change and depend on other variables such as fertilizer use.\\
				
				\paragraph{total_fixed_costs} - Represents the the total fixed costs for this budget. Fixed costs are costs that will be the same regardless of other variables such as land lease.\\
				
				\paragraph{total_general_costs} - This is the total general cost associated with this crop. This represents how much it will cost to produce this crop.\\
				
				\paragraph{total_income_less_variable_cost} - This is total income with out subtracting the total costs.\\
				
				\paragraph{profit} - This is how much money we will make after we adjust for the total cost of producing the crop.\\
				
				\paragraph{breakeven_yield} - This represents the quantity of a crop needed to off set the total cost.\\
								
				\paragraph{breakeven_price} - This represents the price we will have to sell our crop at given that the quantity is the breakeven_yield to off set the total cost.\\
				
				\paragraph{total_yields} - This represents how many units of a crop we produced.\\
				
				\paragraph{primary_income_quantity} - This represents the quantity of the most profitable crop in my budget.\\
				
				\paragraph{primary_income_unit} - This represents the unit of measure for the primary_income_quantity.\\
