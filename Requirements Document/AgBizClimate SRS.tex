...
\section{Specific Requirements}
    ...
    \subsection{Functional Requirements for Backend}
        \subsubsection{Get Location From User}

        \end{Get Location From User}

        \subsubsection{Transform Location}
        ...
        \subsubsection{Plot The resulting data}

        \end{Plot The Resulting data}
    \end{Functional Requirements for Backend}
