...
\section{Design Document}
    \subsection{Original Document}
        \includepdf[pages={1-33}]{./Original-Docs/DesignDoc/AgBizClimateDesignDoc-Fixed.pdf}
...
\section{Project Documentation}
    ...
    \subsection{Project Design}
        ...
        \begin{center}
        \inclduegraphics[width=15cm]{./Images/}
        \end{center}
...
\section{Appendix}
    ...
    \subsection{Appendix 1: Essential Code Listings}
        ...
        \begin{figure}[h!]
            \includegraphics[width=18cm]{./Images/dataGridSearch.png}
    ...
    \subsection{Appendix 2: Catch all}
        \begin{figure}[h!]
            \includegraphics[width=18cm]{./Images/AgBizLanding.png}
            \caption{The landing page for AgBizLogic}
            % \label{code-listing: findData}
        \end{figure}
