...
\section{Design Document}
    ...
    \subsection{Changes}
        ...
        In this section we will discuss the changes to the design of the front end of this application. We will discuss how our designed changed over the course of the term. 
    ...
    \subsection{Configuration Steps}
        ...
        \subsubsection{Mac}
            \begin{itemize}
                ...
                \item Install PostgreSQL: brew install postgresql
        ...
        \subsubsection{Ubuntu}
            \begin{itemize}
                ...
                \item Install PostgreSQL: sudo apt-get install postgresql postgresql-contrib
                \item Move to the directory /AgBiz-Logic/
                \item Install Django dependencies: pip install -r requirements.txt
                \item Install node modules: npm install
                \item Run entrypoint script: ./entrypoint.sh
