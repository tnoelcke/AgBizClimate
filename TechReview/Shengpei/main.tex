...
\begin{document}
    ...
    \end{minipage}\\[2cm]
    \begin{abstract}
	The purpose of this document is to research different technical options and consider possible choices for our application. In this document, I have take the part of container, back end design, and styling framework. I will write three considerable choices for each section of the application. For each option, I will introduce the principle, advantages and disadvantages for this project. At the end, I will choose the applicable option after comparing three choices for the AgBizClimate application. 
